...
/**
 * USAGE:
 * 1 - To use this file replace "adaptivetheme_mqcristobal_white" with the name of
...
// Replace 'adaptivetheme_mqcristobal_white' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function adaptivetheme_mqcristobal_white_form_system_theme_settings_alter(&$form, &$form_state)  {
