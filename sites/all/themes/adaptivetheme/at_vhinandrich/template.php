 ...
 * 1. Rename each function and instance of "at_vhinandrich" to match
 *    your subthemes name, e.g. if your theme name is "footheme" then the function
 *    name will be "footheme_preprocess_hook". Tip - you can search/replace
 *    on "at_vhinandrich".
 * 2. Uncomment the required function to use.
 * 3. Read carefully, especially within at_vhinandrich_preprocess_html(), there
 ...
 */
function at_vhinandrich_preprocess_html(&$vars) {
  global $theme_key;
  ...
  $media_queries_css = array(
    'at_vhinandrich.responsive.style.css',
    'at_vhinandrich.responsive.gpanels.css'
  );
...
function at_vhinandrich_process_html(&$vars) {
}
// */
...
function at_vhinandrich_preprocess_page(&$vars) {
}

function at_vhinandrich_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function at_vhinandrich_preprocess_node(&$vars) {
}

function at_vhinandrich_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function at_vhinandrich_preprocess_comment(&$vars) {
}

function at_vhinandrich_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function at_vhinandrich_preprocess_block(&$vars) {
}

function at_vhinandrich_process_block(&$vars) {
}
// */
