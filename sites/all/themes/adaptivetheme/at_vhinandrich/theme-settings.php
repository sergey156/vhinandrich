...
/**
 * USAGE:
 * 1 - To use this file replace "at_vhinandrich" with the name of
...
// Replace 'at_vhinandrich' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function at_vhinandrich_form_system_theme_settings_alter(&$form, &$form_state)  {
